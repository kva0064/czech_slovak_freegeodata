...
class Elektrickevedeni(Source):
    ...
    def get_vector(self, extent, EPSG):
        ...
        path = '/vsizip/' + os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'vsechnyVrstvy.zip') + '/shp/ElektrickeVedeni.shp'
        vector = QgsVectorLayer(path, "ČÚZK DATA 50 - Elektrické vedeni", "ogr")

...
class VodniTok(Source):
    ...
    def get_vector(self, extent, EPSG):
        ...
        path = '/vsizip/' + os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'vsechnyVrstvy.zip') + '/shp/VodniTok.shp'
        vector = QgsVectorLayer(path, "ČÚZK DATA 50 - Vodní tok", "ogr")
